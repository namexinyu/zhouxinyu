...
// const env.api_url = "https://www.easy-mock.com/mock/59f6f315ee3c3f29ab2f9754/broker";
...
let AssistanceService = {
    ...
    GetDepartEntrustList: (params = {}) => {
        ...
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_GetDepartEntrustList',
    ...
    GetEntrustReplyList: (params = {}) => {
        openDialog({id: 'spinner', type: 'spinner'});
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_GetEntrustReplyList',
            params: params
        }, baseToDo, {EmployeeMapID: true});
    },
    // 评价部门委托
    EvaluateDepartEntrust: (params) => {
        openDialog({id: 'spinner', type: 'spinner'});
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_EvaluateDepartEntrust',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 评价部门委托
    CloseDepartEntrust: (params) => {
        openDialog({id: 'spinner', type: 'spinner'});
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_DepartEntrustClose',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 新建部门委托
    BuildDepartEntrust: (params) => {
        openDialog({id: 'spinner', type: 'spinner'});
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_BuildDepartEntrust',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 回复部门委托
    ReplyDepartEntrust: (params = {}) => {
        openDialog({id: 'spinner', type: 'spinner'});
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_ReplyDepartEntrust',
            params: transferQueryParams(params)
        }, baseToDo, {EmployeeMapID: true});
    },
    // 设置部门委托已读状态
    SetReplyReadStatus: (params = {}) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Entrust/BK_ENTR_SetReplyReadStatus',
            params: params
