...
let Service = {
    ...
    getEventTypeDetail: (params) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Event/BK_WJG_DayEventDetail',
            params: params
        }, baseToDo, {EmployeeMapID: true});
    },
    // 事件处理完毕
    ...
    GetEmployeeByName: (params) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Event/BK_WJG_GetEmployeeByName',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 新增事件处理人员
    AddOnDuty: (params) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Event/BK_WJG_AddOnDuty',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 查询我的排班身份
    GetMyDutyDepartment: (params) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Event/BK_WJG_GetMyDutyDepartment',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    },
    // 事件导出
    EventList: (params) => {
        return HttpRequest.post({
            url: env.api_url + '/BK_Event/BK_EXCEL_EventList',
            params: params || {}
        }, baseToDo, {EmployeeMapID: true});
    }
};
