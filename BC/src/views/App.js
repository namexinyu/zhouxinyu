...
export default createPureComponent(({ children, location, state_dialog, state_sideNav, state_tabPage, state_business_header_accountInfo }) => {
    return (
        <Layout style={{ height: '100vh' }}>
            <PageHeader {...state_business_header_accountInfo} />
            <Layout>
