          ...
          <div className="event-detail__ft">
            <div className="event-action-area">
              <div className="event-action-area__hd flex flex--y-center">
                ...
                <div>
                  <a className={classnames('action-btn', {
                    disabled: Detail.DealStatus === 4 || Detail.DealStatus === 5 || isEndEvent || Detail.Department === 5 || Detail.Department === 5 || Detail.Department === 4 || Detail.Department === 3 || Detail.Department === 1
