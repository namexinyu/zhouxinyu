...
if (__DEV__)
    UTIL.Storage.sessionStorage('mams_finance_session_login_info').putItems({
        "token": "mFPq92d08ggEWcEOj1xW0KtSt4oIqr0QW5+/BBmxiMg=",
        "accountList": "[20]",
        "employeeId": 562,
        "accountName": "tiger",
        "loginTime": "2018/5/2 下午1:52:18",
        "departmentName": "财务工作台"
    });
CONFIGURATION.initAppSessionStorage({
    LOGIN_INFO_SESSION_STORAGE: UTIL.Storage.sessionStorage('mams_finance_session_login_info')
});
