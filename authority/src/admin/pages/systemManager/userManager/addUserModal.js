...
class AddUserModel extends React.Component {
  ...
  handleOnchangeJoblist = (e, item) => {
    this.props.form.getFieldValue('JobTitleName') === item && item.props.item.JobTitleName ? message.error('岗位名称和上级岗位不可相同') : '';
  }
          ...
          <Form>
            ...
            >
              {getFieldDecorator('JobTitleName', {
                ...
                <Input maxLength="10" placeholder="请输入真实姓名" autoComplete="off" />
              )}
            </FormItem>
            <FormItem
              label="上级岗位"
            ...
            >
              {getFieldDecorator('LeaderTitleID', {
                initialValue: cityModelValue.TabLeaderTitleID
              })(
                <Select
                  allowClear={true}
                  placeholder="请选择上级岗位"
