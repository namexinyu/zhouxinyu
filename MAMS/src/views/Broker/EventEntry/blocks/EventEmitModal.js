...
const brokerName = AppSessionStorage.LOGIN_INFO_SESSION_STORAGE.getItem('accountName');
  ...
  handleOnOk = () => {
    this.props.form.validateFields((errors, values) => {
      if (!errors) {
        ...
        console.log(values, "55555555555555");
        const {
          uploadImgs
        } = this.state;
        let Remark = "";
        ...
        // // } else {
        //   EventService.getEventEntryForExp({
          ...
          <Row>
            ...
            <Col span={24}>
              <FormItem label="事件分类" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
                {getFieldDecorator("EventSubType", {
                  initialValue: ""
                })(
