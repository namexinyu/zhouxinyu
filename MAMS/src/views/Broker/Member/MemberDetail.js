  ...
  return (
    <div className="">
      <MemberDetailBox detailInfo={{ ...store_broker.state_broker_member_detail_info }}
        ...
        impressionInfo={store_broker.state_broker_member_detail_info.impressionInfo}
        expectationInfo={store_broker.state_broker_member_detail_info.expectationInfo}
