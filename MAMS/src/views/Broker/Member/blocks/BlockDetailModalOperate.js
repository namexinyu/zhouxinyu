...
class BlockDetailProcess extends React.PureComponent {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.pocketInfo.insertMemberEnrollRecordFetch.status === 'success' && this.props.pocketInfo.insertMemberEnrollRecordFetch.status !== 'success') {
      ...
      const Remark = this.props.editPocketRemark;
      if (CaseLevel.value == "" && BirthYear.value == "" && Province.value == "" && Education.value == "" && MaritalStatus.value == "" && Wycas.value.length == 0 && WorkYearStr.value == "" && (this.props.editPocketRemark !== undefined && this.props.editPocketRemark.value && this.props.editPocketRemark.value !== "") && this.props.pocketInfo.type !== 0) {
        let impressionInfo = this.props.impressionInfo;
        ...
        Modal.confirm({
          ...
          onCancel () {
            getPersonPostInfo(nextProps.editPocketRecruit.value.value);
          }
        });
      }
      if ((CaseLevel.value !== "" || BirthYear.value !== "" || Province.value !== "" || Education.value !== "" || MaritalStatus.value !== "" || Wycas.value.length !== 0 || WorkYearStr.value !== "") && (Remark == {} || Remark.value == undefined || Remark.value == "")) {
        if (nextProps.patchProcessDemandsFetch.status === 'success' && (Remark !== {} && Remark.value !== undefined && Remark.value !== "")) {
          this.getPersonPostInfo(nextProps.pocketInfo.RecruitTmpID);
          return;
        } else if (nextProps.patchProcessDemandsFetch.status === 'success' && (Remark == {} || Remark.value == undefined || Remark.value == "")) {
          this.getPersonPostInfo(nextProps.pocketInfo.RecruitTmpID);
        } else if (nextProps.pocketInfo.insertMemberEnrollRecordFetch.status === 'success' && (Remark == {} || Remark.value !== undefined || Remark.value !== "")) {
          this.getPersonPostInfo(nextProps.pocketInfo.RecruitTmpID);
        }
