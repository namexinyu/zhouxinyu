...
export default class AssistanceListMy extends React.PureComponent {
    ...
    handleTabTable = (value, filter, sorter) => {
        let data = this.props.list;
        setParams(data.state_name, {currentPage: value.current, pageSize: value.pageSize});
    };
            ...
            <Row>
                <div className="container bg-white mt-20">
                    ...
                    <Row className="mb-8">
                        <Col>
                            <Button type="primary"
                                    onClick={() => setParams(asNew.state_name, {showModal: true})}>新建施令</Button>
                        </Col>
                    </Row>
                ...
                <AssistanceNewModal asNew={asNew} recruitNameList={this.props.recruitNameList}></AssistanceNewModal>
