...
var transferRequestJSON = function (params) {
    let p = params || {};
...
var getSign = function (dataStr, TimeStampStr) {
...
function MD5(string, sByte, caseStr) {
    ...
    if (caseStr === 'lowerCase') {
        return sByte === 16 ? (md5_WordToHex(b) + md5_WordToHex(c)).toLowerCase() : (md5_WordToHex(a) + md5_WordToHex(b) + md5_WordToHex(c) + md5_WordToHex(d)).toLowerCase();
    } else {
        return sByte === 16 ? (md5_WordToHex(b) + md5_WordToHex(c)).toUpperCase() : (md5_WordToHex(a) + md5_WordToHex(b) + md5_WordToHex(c) + md5_WordToHex(d)).toUpperCase();
    }
