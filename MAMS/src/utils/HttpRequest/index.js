...
let doRequest = (url, options, todoObj) => {
  const needThrottleCheck = options.needThrottleCheck;
  if (needThrottleCheck !== false) {
...
function translatePostData (params, opts) {
  let loginId = AppSessionStorage.LOGIN_INFO_SESSION_STORAGE.getItem('loginId') || '';
