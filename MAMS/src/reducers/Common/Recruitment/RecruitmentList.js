...
function InitialState() {
    return {
        ...
        checkedTagStockList: [],
        spreadTagType: false,
        spreadMemberType: false,
        spreadMatchEnt: false,
        spreadCheckTag: true
    };
}
...
const Reducer = {
    ...
    reducers: {
        ...
        [GetTagStockList]: merge((payload, state) => {
            return {
                GetTagStockListFetch: {
                    status: 'pending'
                }
        ...
        [GetTagStockList.success]: merge((payload, state) => {
            return {
                GetTagStockListFetch: {
                    status: 'success',
                    response: payload
                },
                tagStockList: (payload.Data || {}).RecordList || []
            };
        }),
        [GetTagStockList.error]: merge((payload, state) => {
            return {
                GetTagStockListFetch: {
                    status: 'error',
                    response: payload
