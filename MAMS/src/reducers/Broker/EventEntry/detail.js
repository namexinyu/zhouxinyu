...
import Eventalter from "ACTION/Broker/EventEntry/eventalter";

const STATE_NAME = 'state_broker_eventdetail';
function arrkey(arr) {
    ...
    reducers: {
        ...
        [Eventdetail.success]: merge((payload, state) => {
            ...
            return {
                ...
                PicUrls: payload['Data']['Detail'] ? payload['Data']['Detail']['PictureList'] ? payload['Data']['Detail']['PictureList'] : [] : [],
