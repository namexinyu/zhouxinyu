...
//    }
    ...
    componentWillReceiveProps(nextProps) {
        //     if((this.props.message.NotifyType !== nextProps.message.NotifyType) || (this.props.message.pageSize !== nextProps.message.pageSize) || (this.props.message.currentPage !== nextProps.message.currentPage) || (this.props.message.StartTime !== nextProps.message.StartTime)) {
        //         this.startParams(nextProps.message);
        //         this.setState({
        //             flag: false
        //          });
        //    }else{
    ...
    render() {
        ...
        return (
            <div className="message">
                <div className="ivy-page-title" style={{display: 'flex', justifyContent: 'space-between'}}>
                    <h1>消息列表</h1>
                    <div>
