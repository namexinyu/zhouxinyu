...
export default class PerformanceList extends QueryListPage {
    constructor(props) {
        ...
        this.title = (
            <div className="flex">绩效查询<span style={{
                color: "#ff0000",
                fontSize: "14px",
                fontWeight: "600",
                marginLeft: "20px"
            }}>*注：本月结算日前，绩效仅供参考！</span></div>
    ...
    handleCreateParam(d) {
        ...
        // BrokerAction.GetPerformanceList(param);
    }
    ...
    handleExport() {
        ...
        if (this.oriParamJson) {
            ...
            BrokerService.ExportPerformanceData(ex_param).then((res) => {
    ...
    tableColumns(orderParams) {
        return [
            ...
            {title: '昵称', dataIndex: 'NickName', width: 64},
