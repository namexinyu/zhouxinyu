        ...
        return (
            <div className='query-page-view'>
                <div className="ivy-page-title" style={{position: 'relative'}}>
                    <h1>{this.title}</h1>
                    {/* {this.derive ? <span className="i-refresh" onClick={() => this.handleRefresh()}>
                ...
                <Row>
                    <div className="container-fluid">
                        <div className="container bg-white mt-20">
                            ...
                            {this.extraComponent()}
                            {this.renderCustomComponent && this.renderCustomComponent()}
                            <Table columns={this.tableColumns(data.orderInfo)}
