...
import {Form, Row, Col, Button, Input, Select, Table, DatePicker, message, Radio} from 'antd';
    ...
    render() {
        ...
        return (
            <Form onSubmit={(e) => this.handleSearch(e)}>
                <Row gutter={15}>
                    {this.createItems()}
                    {this.props.extraItems ? this.props.extraItems.map(item => item) : ''}
                    <Col className="gutter-box" span={6} offset={(3 - (this.props.formItems.length + (this.props.extraItems ? this.props.extraItems.length : 0)) % 4) * 6}>
