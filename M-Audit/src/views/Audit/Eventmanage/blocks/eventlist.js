...
import getEventList from "ACTION/Common/Assistance/eventlist";
...
class EventList extends React.PureComponent {
  ...
  render() {
    ...
    console.log(this.props.eventListInfo.pageQueryParams);
    const warmInfo = (
      <ul>
        <li>1.点击【处理完毕】后，经纪人未处理，超过00:00，系统划转至【已处理】类目中；</li>
    ...
    console.log(this.props, "6555555555555555555555555");
    return (
                  ...
                  <div>
                    <Form>
                      <Row gutter={8}>
                        ...
                        <Col span={8}>
                          <FormItem label="面试日期" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                          <div className="flex">
                        ...
                        <Col span={8}>
                          <FormItem label="与我相关" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
