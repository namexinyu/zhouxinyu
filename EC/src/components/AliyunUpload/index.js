...
class PicturesWall extends React.PureComponent {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.defaultFileList.length && (this.state.fileList.length === 0)) {
            this.setState({
    ...
    customRequest(o) {
        let client = new AliSignature().clientWrapper({
            ...
            // console.log(client);
            // console.log('custom.....', o);
            // console.log(client.signatureUrl('mm/abc/avatar.png'));
        }, () => {
