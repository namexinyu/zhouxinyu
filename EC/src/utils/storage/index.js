...
Storage.prototype.putItems = function (putObj) {
    let jsonStr = self.localStorage.getItem(this.name);
    let obj = JSON.parse(jsonStr);
    self.localStorage.setItem(this.name, JSON.stringify(Object.assign({}, obj, putObj)));
};
...
SessionStorage.prototype.putItems = function (putObj) {
    let jsonStr = self.sessionStorage.getItem(this.name);
    let obj = JSON.parse(jsonStr);
    self.sessionStorage.setItem(this.name, JSON.stringify(Object.assign({}, obj, putObj)));
};
...
let CreateStorage = {
    localStorage: function (name) {
        let myStorage = new Storage(name);
    ...
    sessionStorage: function (name) {
        let myStorage = new SessionStorage(name);
