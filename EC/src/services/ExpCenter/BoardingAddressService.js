...
let BoardingAddressService = {
    // 获取上车地址列表
    getBoardingAddressList: (params) => {
        return HttpRequest.post({
            url: API_URL + '/EC_AddrManage/EC_ADMA_GetLocationList',
            params: params || {}
        }, baseToDo, {ignoreBrokerID: true});
    },
    // 编辑上车地址
    editBoardingAddress: (params) => {
        return HttpRequest.post({
            url: API_URL + '/EC_AddrManage/EC_ADMA_BuildOrModifyLocation',
            params: params || {}
        }, baseToDo, {ignoreBrokerID: true});
    }
};
export default BoardingAddressService;